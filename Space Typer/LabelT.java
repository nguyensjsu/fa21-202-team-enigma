 ...
 * displays.  
 * 
 * NOTE: LabelT is used for special Labels that need to be on top of the Flashlight layer (Ricky)
 *
 * @author Amjad Altadmri 
 * @version 1.1
 */
public class LabelT extends Actor
{
     ...
     */
    public LabelT(int value, int fontSize)
    {
     ...
     */
    public LabelT(String value, int fontSize)
    {
        this.value = value;
